# Movement Detection using MLP (Time + FFT Features)
...
def main():
    ...
    plt.figure()
    plt.imshow(cm)
    plt.title("Movement Detection – MLP (Time + FFT)")
    ...
    plt.savefig("confusion_matrix_mlp_fft.png", dpi=300, bbox_inches="tight")
    plt.show()

    print("\nSaved plot as confusion_matrix_mlp_fft.png")
